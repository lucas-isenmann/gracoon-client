...
export const control_point_interactorV2 = new InteractorV2("control_point", "Edit control points", "h", ORIENTATION_INFO.RIGHT, "control_point", "default", new Set([DOWN_TYPE.LINK, DOWN_TYPE.CONTROL_POINT]));
