...
export const eraser_interactorV2 = new InteractorV2("eraser", "Erase objects", "r", ORIENTATION_INFO.RIGHT, "eraser", 'url("../img/cursors/eraser.svg"), auto', new Set([DOWN_TYPE.STROKE]));
